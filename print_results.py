...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # If print_incorrect_dogs is True and there were incorrect dog classifications, print them
    ...
    # If print_incorrect_breed is True and there were incorrect breed classifications, print them
